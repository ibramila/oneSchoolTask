...
function ProgramsPart2() {
  return (
    <section >
      <div className="container">
        <div className='programsPart2'>
          <div className='programsPart2_info'>
          ...
          <img src="https://preview.colorlib.com/theme/oneschool/images/undraw_teacher.svg" alt="part1" />
